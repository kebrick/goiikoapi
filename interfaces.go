...
type IDeliveries interface {
	...
	UpdateOrderDeliveryStatus(ctx context.Context, organizationID string, orderID string, deliveryStatus string, deliveryDate *string) (*BaseResponseModel, *CustomErrorModel, error)
